...
import pt.unl.fct.di.novasys.network.babelChannels.messages.EndOfStreaming;
import pt.unl.fct.di.novasys.network.babelChannels.messages.StreamMessage;
...
public class ReceiveFileProtocol extends GenericProtocol {
    ...
    private void uponInConnectionDown(OnStreamConnectionUpEvent event, int channelId) {
        try {
