...
public class UDPMainTester {
    ...
    public static void main(String [] args) throws Exception {
        ...
        properties.setProperty(pt.unl.fct.di.novasys.network.ChannelLogicsWithNetty.udpSupport.client_server.NettyUDPServer.MIN_UDP_RETRANSMISSION_TIMEOUT,"500");
        properties.setProperty(pt.unl.fct.di.novasys.network.ChannelLogicsWithNetty.udpSupport.client_server.NettyUDPServer.MAX_SEND_RETRIES_KEY,"100");
