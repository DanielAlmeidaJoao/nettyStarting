...
public class MessageFailedEvent extends InternalEvent {
    ...
    private final pt.unl.fct.di.novasys.babel.internal.BabelMessage msg;
     ...
     */
    public MessageFailedEvent(pt.unl.fct.di.novasys.babel.internal.BabelMessage msg, Host to, Throwable cause, int channelId) {
