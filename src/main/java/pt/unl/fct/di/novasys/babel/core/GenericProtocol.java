...
public abstract class GenericProtocol {
    ...
    protected final String openMessageConnection(Host peer, int channelId) {
        return babel.openMessageConnection(channelId, peer, protoId);
    }
    protected final String openStreamConnection(Host peer, int channelId, StreamType streamType) {
        return babel.openStreamConnection(channelId, peer, protoId,streamType);
    }
    ...
    /**
     * Used by pt.unl.fct.di.novasys.babel to deliver channel events to protocols. Do not evoke directly.
     */
    ...
    /**
     * Used by pt.unl.fct.di.novasys.babel to deliver channel messages to protocols.
     */
    ...
    /**
     * Used by pt.unl.fct.di.novasys.babel to deliver channel message failed events to protocols. Do not evoke directly.
     */
    ...
    /**
     * Used by pt.unl.fct.di.novasys.babel to deliver timer events to protocols. Do not evoke directly.
     */
    ...
    /**
     * Used by pt.unl.fct.di.novasys.babel to deliver notifications to protocols. Do not evoke directly.
     */
    ...
    /**
     * Used by pt.unl.fct.di.novasys.babel to deliver requests/replies to protocols. Do not evoke directly.
     */
            ...
            try {
                ...
                switch (pe.getType()) {
                    ...
                    case CUSTOM_CHANNEL_EVENT:
                        ...
                        break;
                    default:
                        throw new AssertionError("Unexpected event received by pt.unl.fct.di.novasys.babel. protocol "
                                + protoId + " (" + protoName + ")");
                }
            } catch (Exception e) {
