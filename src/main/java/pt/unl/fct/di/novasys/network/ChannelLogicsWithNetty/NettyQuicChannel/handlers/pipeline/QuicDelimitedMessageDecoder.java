...
public class QuicDelimitedMessageDecoder extends ByteToMessageDecoder {
    private static final Logger logger = LogManager.getLogger(QuicDelimitedMessageDecoder.class);
    ...
    protected void decode(ChannelHandlerContext ctx, ByteBuf msg, List<Object> out) throws Exception {
        while(msg.readableBytes()>=Integer.BYTES){
            ...
            if(QUICLogics.APP_DATA==msgType){
                try {
                    BabelMessage babelMessage = serializer.deserialize(msg.readSlice(length));
