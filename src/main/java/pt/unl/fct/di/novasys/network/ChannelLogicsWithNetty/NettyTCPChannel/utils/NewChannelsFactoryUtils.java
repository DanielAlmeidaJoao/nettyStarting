...
public class NewChannelsFactoryUtils {
    ...
    public static Properties udpChannelProperties(String address, String port){
        ...
        properties.setProperty(pt.unl.fct.di.novasys.network.ChannelLogicsWithNetty.udpSupport.client_server.NettyUDPServer.MIN_UDP_RETRANSMISSION_TIMEOUT,"200");
        properties.setProperty(pt.unl.fct.di.novasys.network.ChannelLogicsWithNetty.udpSupport.client_server.NettyUDPServer.MAX_UDP_RETRANSMISSION_TIMEOUT,"100");

        properties.setProperty(pt.unl.fct.di.novasys.network.ChannelLogicsWithNetty.udpSupport.client_server.NettyUDPServer.MAX_SEND_RETRIES_KEY,"200");
        ...
        //properties.setProperty(pt.unl.fct.di.novasys.network.ChannelLogicsWithNetty.udpSupport.client_server.NettyUDPServer.UDP_BROADCAST_PROP,"10");
