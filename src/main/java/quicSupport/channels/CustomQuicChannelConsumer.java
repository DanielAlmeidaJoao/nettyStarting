...
public interface CustomQuicChannelConsumer {
    ...
    void channelActive(QuicStreamChannel streamChannel, byte [] controlData, InetSocketAddress remotePeer, TransmissionType type, StreamType streamType);
    ...
    void streamCreatedHandler(QuicStreamChannel channel, TransmissionType type, String customId, boolean inConnection, StreamType streamType);
